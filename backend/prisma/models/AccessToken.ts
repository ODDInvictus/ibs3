...
export type AccessTokenWhereInput = {
	...
	type?: Prisma.StringFilter<'AccessToken'> | string
	userId?: Prisma.IntFilter<'AccessToken'> | number
	lastUsed?: Prisma.DateTimeFilter<'AccessToken'> | Date | string
...
export type AccessTokenScalarWhereWithAggregatesInput = {
	...
	type?: Prisma.StringWithAggregatesFilter<'AccessToken'> | string
	userId?: Prisma.IntWithAggregatesFilter<'AccessToken'> | number
	lastUsed?: Prisma.DateTimeWithAggregatesFilter<'AccessToken'> | Date | string
}
...
export type AccessTokenCreateNestedManyWithoutUserInput = {
	create?:
		| Prisma.XOR<Prisma.AccessTokenCreateWithoutUserInput, Prisma.AccessTokenUncheckedCreateWithoutUserInput>
		| Prisma.AccessTokenCreateWithoutUserInput[]
		| Prisma.AccessTokenUncheckedCreateWithoutUserInput[]
...
export type AccessTokenSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export type AccessTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
	runtime.Types.Extensions.GetOmit<'token' | 'name' | 'type' | 'userId' | 'lastUsed', ExtArgs['result']['accessToken']>
...
export type AccessTokenGetPayload<S extends boolean | null | undefined | AccessTokenDefaultArgs> = runtime.Types.Result.GetResult<
	Prisma.$AccessTokenPayload,
	S
>

export type AccessTokenCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<
	AccessTokenFindManyArgs,
...
> {
	 ...
	 * const accessTokenWithTokenOnly = await prisma.accessToken.findMany({ select: { token: true } })
	 *
	 */
	findMany<T extends AccessTokenFindManyArgs>(
		args?: Prisma.SelectSubset<T, AccessTokenFindManyArgs<ExtArgs>>,
	): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$AccessTokenPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions>>
...
export interface AccessTokenFieldRefs {
	...
	readonly type: Prisma.FieldRef<'AccessToken', 'String'>
	readonly userId: Prisma.FieldRef<'AccessToken', 'Int'>
	readonly lastUsed: Prisma.FieldRef<'AccessToken', 'DateTime'>
}

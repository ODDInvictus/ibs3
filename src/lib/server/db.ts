...
import { PrismaClient, type Transaction, type FinancialPerson } from '@prisma/client';
...
prisma.$use(async (params, next) => {
  ...
  const changeBalanceCommittee = async (tx: PrismaClient, fp: FinancialPerson, transaction: Transaction, type: IncOrDec) => {

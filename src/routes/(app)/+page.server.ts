...
export const load = (async ({ locals }) => {
	...
	return {
		...
		tutorialEgg: shouldShowEgg(
			'3BoXkqmZITrIkVQ2WzaFXTROlx8VxjRKinjWcz6H1LLdVfZnLP',
			locals.user.id
		),
		knoppersEgg: shouldShowEgg('wCZXlGQDecVPXIrQyz8lmR8BLpe730hTPu0mEVcFetBPjWXxwH', locals.user.id)
	};

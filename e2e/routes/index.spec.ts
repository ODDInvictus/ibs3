...
test('test birthdays', async ({ page }) => {
  ...
  await expect(page.getByRole('main')).toContainText('Verjaardagen Naam Geboortedatum Toekomstige leeftijd Hoeveel dagen nog admin Test (admin) 1 januari 25 270 colosseum Test (colosseum) 1 januari 25 270 feut Test (feut) 1 januari 25 270 financie Test (financie) 1 januari 25 270 senaat Test (senaat) 1 januari 25 270 lid Test (lid) 1 januari 25 270');
});
